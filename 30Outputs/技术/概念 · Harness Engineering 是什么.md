...
来源：[Anthropic说：不要在等下一代模型了，立刻马上做Harness！ - 探索AGI](https://mp.weixin.qq.com/s/iTLZQHw9Dkt6AsDumZZJNQ)

---

![](https://mmbiz.qpic.cn/sz_mmbiz_jpg/durt1819APpR3CvNdqdl7wyjZEAcwusZPGToHwcYsqPiaEpLNoibyWfYsfMr1WF6NItsclk2Bx4XShvqHibGeicEVn3Zh7FicMlt3ibst8l5SjqTo/0?wx_fmt=jpeg)
...
![](https://mmbiz.qpic.cn/mmbiz_png/durt1819APphBp7aS7BE5mCqGSuxkgFYz6CicyUEDNB5ng95CAU1TIwTDhQLAwGUh0Ygqtf52T6zW6XMabNrH91rEwA7WfNXibf60t0p2iaZ9U/640?wx_fmt=png&from=appmsg)

现在业内共识，当一个技术被Anthropic以博客的形式分享出来，说明这个技术是必需，且成熟的方案了。

![](https://mmbiz.qpic.cn/mmbiz_png/durt1819APponTCPV67eJtoa9LPEOSOJ52hhTib5fVLicOfqbpXjOsAsvsCsQZHMEktkKyJwuNianNkzL3ibR1Sd8sjHPZ61SNCJRd9NhKGB2aE/640?wx_fmt=png&from=appmsg)

这层壳，现在有了一个正式的名字：**Harness**。

围绕它展开的工程实践，叫 **Harness Engineering**。2026 年 AI 圈最热的话题之一。

![](https://mmbiz.qpic.cn/mmbiz_png/durt1819APpXUhcVxxRcXa2HJQ1iaA8iadibwKzeYaKxib1vWar9spQsLRbe3d2OZ4IrJZjbLRiberx00x6rsta1PmdA3tU8N5Rk4AQ1p3BtxrVM/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/mmbiz_png/durt1819APq1PXfqMDfNiciby3lPXzQStXX3pWgUuvHNnpdrl9UPGOPyd3sq6759yWvgQ4ic5jN52YhPaP5RkicaJPv1yXTYZAZveuJOtqKKMk4/640?wx_fmt=png&from=appmsg)

打个比方：

- Prompt Engineering 是写好一封邮件
- Context Engineering 是把相关附件都带上
- Harness Engineering 是搭建整个工作环境——让 Agent 能持续、稳定、高质量地工作。它包含了上下文工程，但在更高的层面运作：约束、反馈循环、架构规则、工具链、生命周期管理

这个词最早来自 Mitchell Hashimoto——HashiCorp 联合创始人、Terraform 的缔造者。他今年 2 月写了篇博客，把自己使用 AI 编程的进化拆成了六个阶段。第五个阶段叫 **Engineer the Harness**。

![](https://mmbiz.qpic.cn/sz_mmbiz_png/durt1819APrqLHkEYVDcDxyFWqhhZ7FW1OjziaK8A8YU8g1cccvPpDPnvybOKz0yearB0CzIQgyb6LCYiaBaxOIhnNBgGCyQKpDkv8BFj22SA/640?wx_fmt=png&from=appmsg)

定义只有一句话：

> 每当你发现 Agent 犯了一个错误，你就花时间去工程化一个解决方案，让它再也不会犯同样的错。

![](https://mmbiz.qpic.cn/mmbiz_png/durt1819APrJlMu3cd8UtJ60NTjEz7q9qmOZiaFjKnaBp7SoQ5DZrianKZtNzdMiaFwiah5tBibpmTP5JWAtJJLzaT36L5WSU7lA2PcpVHQYF3f0/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/mmbiz_png/durt1819APoLxMTXEu9icH4G4h8jXe0MhUhr7GOOpiavjjRblbnRM1wVOyMkJiamXkf2jsYVxVib7QsxyQJJGw3qiba1ibO4Kx1bIxCV7Dnx5rmFA/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/mmbiz_jpg/durt1819APo0Q6eZu9udYtOdVOkTlkzwXicbsTBaGVe8sgpGg7DGRBkZKvwSEpoasTeCQuXDv7fsGIAZ5fjlZwmRfcsdlHAkorTO4jQ3iaBgc/640?wx_fmt=jpeg&from=appmsg)
...
![](https://mmbiz.qpic.cn/mmbiz_jpg/durt1819APrL0GwvrYlibpJazzia9gKobLdU7Wf9kUQgakk6qzEqnL5tuJf6KjgjSq1bUKp3O73icZHdcibqicSmhZOd3L05jP36J6uZzcy3Qibfw/640?wx_fmt=jpeg&from=appmsg)
...
![](https://mmbiz.qpic.cn/mmbiz_png/durt1819APr7juDcRPWhb7L5edm9Ro5auINgPhHhVRDTXCmdiahCQtWofWYFSMevbmAJzQQYQHFiakZmoRpz4eUk2pCxdT2dnuT0F0AMw6oFk/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/durt1819APr3cQxOicYkSrg6ql0usH974fVxFIibwnuvX2Z5RB26amgz08AOkF1whkBka4PNwCy16d5VVyianf98G09ZtT2sgELgBCaWjDJUCM/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/mmbiz_jpg/durt1819APrRcibp3kliadPBQU1jYwuOOISD9fZxzw12BJG9zkIfOUP0iavfkvoiajJibWgwuM6wibg2bzyDDhphhXXDvDLyHOeXNCTcQQYR3nAy4/640?wx_fmt=other&from=appmsg)
*Solo 模式输出：游戏画面（核心功能不响应）*

harness 模式出来的版本，编辑器更完整，游戏能玩，物理引擎有些粗糙但核心交互是通的。

![](https://mmbiz.qpic.cn/mmbiz_jpg/durt1819APoRvicg1YYaS0eiatgoNv9jQfo5AMS7r0RQUTVibVXlKZiacaUib3GV9giblszbRMdvvRwk4uZIqexLKrfZ1RmGiaXAwdxFhrjXfzmAHk/640?wx_fmt=other&from=appmsg)
*Harness 模式输出：游戏可以玩*

evaluator 的 bug 报告精确到哪行代码出了什么问题。

![](https://mmbiz.qpic.cn/mmbiz_png/durt1819APpA6KT4HQGh2I0EjcXLYJlfJ9KE6TJIDuwMCehjIWnSaITsib8npCcR8tLu8SDKl8I6FPdh5WuGVAqgbLHV3O2lXk9r5qWRZucY/640?wx_fmt=png&from=appmsg)
...
- **Anthropic**：solo 模式 20 分钟 / $9（核心功能坏），harness 模式 6 小时 / $200（功能可用）。后续优化后的 harness，一次完整构建约 4 小时 / $125。
...
他的理由是：在推理模型出现之前，开发者在 GPT-4o 上搭了大量复杂的 Agentic 系统来模拟推理能力。路由器、编排器、multi-agent 协作。然后推理模型一出来，这些东西一夜之间不需要了。在很多场景下，它们反而让效果更差了。
...
![](https://mmbiz.qpic.cn/mmbiz_png/durt1819APoHWZBuE1JnJfIChSGjOyIjJ2yDTHGaBHxmeLBuWdKWFhLLL9clSzD5Xice5lM9SLeXeyyDVkUn1tJHYNhaNuicbM5pjCUptSb2M/640?wx_fmt=png&from=appmsg)
...
因为 4.5 有一种"上下文焦虑"，当它感觉自己快用完上下文窗口时，会提前开始收尾工作，质量急剧下降。整套 sprint + context reset 的机制就是为了对付这个问题。
...
- [[tech.智能体架构对比-OpenClaw与Harness]] — OpenClaw 与 Harness 架构对比
- [[洞察 · AI 使用经验与学习曲线]] — 如何更好地使用 AI